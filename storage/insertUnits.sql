...
SELECT r.id AS receipt_no,i.id AS receipt_item_no,r.vendor,r.tdate,i.itemno,i.itemdesc,i.baseprice,i.d1,i.d2,i.d3,i.d4,r.netprice,r.created_at FROM notebook_receipt AS r
